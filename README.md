...
**Project Highlights**
1.End-to-end Retrieval-Augmented Generation pipeline.
2.Local semantic search using FAISS.
3.Open-source embedding and language models.
4.Automated evaluation using RAGAS.
5.Modular architecture for easy experimentation with different embedding models, LLMs, and vector databases.
6.User-friendly Streamlit interface for document-based question answering.
